...
Tot seguit presentem el seguit de consideracions extres de caràcter geogràgic i/o metereològic que tindrem en compte en el nostre model. L'estudi climàtic s'ha efectuat amb dades extretes de la web de \textit{Nasa Power}, veure \bibitem{6}.
\begin{itemize}
    \item Mont-rós és una localitat amb un horitzó no pla, ja que està envoltat de muntanyes que limiten les hores de llum diàries. Per tal de tenir present aquest fenomen cal introduir una variació en els angles \phi inicials i finals. Eliminem els angles $\phi < -70$ º i $\phi > 80$ º, en tant que no contribueixen de manera significativa a la irradiació efectiva de les plaques solar.
\end{itemize}
...
Aquesta informació l'hem comparada amb un model referencial que presenta característiques i ubicacions semblants a la nostra placa fotovoltaica, obtingut a partir de la plataforma PVGIS. A les figures següents es poden observar els histogrames corresponents a l'energia elèctrica generada cada mes al llarg d'un any de la nostra placa i la obtinguda a PVGIS. 
\begin{figure}[h!]
    \centering
...
\resizebox{\textwidth}{!}{
    \begin{tabular}{ccccccccccccc}
        \caption{Comparativa anual de l'energia generada amb PVGIS i el nostre model.}
        \toprule
        \textbf{E (kW$\cdot$h)} & \textbf{Gener} & \textbf{Febrer} & \textbf{Març} & \textbf{Abril} & \textbf{Maig} & \textbf{Juny} & \textbf{Juliol} & \textbf{Agost} & \textbf{Setembre} & \textbf{Octubre} & \textbf{Novembre} & \textbf{Desembre} \\
        \midrule
        PVGIS         & 42.05 & 47.35 & 55.13 & 50.56 & 54.98 & 55.54 & 62.04 & 61.03 & 54.57 & 48.27 & 38.93 & 39.81 \\
        Model  & 53.91 & 56.99 & 76.17 & 67.97 & 77.00 & 90.62 & 104.73 & 95.69 & 72.34 & 78.60 & 67.46 & 61.87 \\
        \bottomrule
    \end{tabular}
}
