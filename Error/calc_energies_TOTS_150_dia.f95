program vels
    ...
    real(kind=8), dimension(365*150,p) :: matr_Ek
    real(kind=8), dimension(365*150,p) :: matr_Ep
    real(kind=8), dimension(365*150,p) :: matr_E
...
open(unit=20,file='matriuEks_TOTS_150_dia.dat',status='replace')
    do i = 1, Nt
        write(20,*) matr_Ek(i,:)
    end do
close(20)

open(unit=30,file='matriusEps_TOTS_150_dia.dat',status='replace')
    do i = 1, Nt
        write(30,*) matr_Ep(i,:)
    end do
close(30)

open(unit=40,file='matriusEs_TOTS_150_dia.dat',status='replace')
    do i = 1, Nt
        write(40,*) matr_E(i,:)
    end do
close(40)
